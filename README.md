...
- **`renderUsernameForEveryMessage`** _(Bool)_ - When false, username will only be displayed on message when a consecutive message is from the same user on the same day; default is `true`
