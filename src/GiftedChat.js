...
class GiftedChat extends React.Component {
  ...
  getBasicMessagesContainerHeight() {
    return this.getMaxHeight() - this.calculateInputToolbarHeight(this.state.composerHeight);
  }
  ...
  onKeyboardWillShow(e) {
    ...
    const newMessagesContainerHeight = this.getBasicMessagesContainerHeight() - this.getKeyboardHeight() + this.getBottomOffset();
    if (this.props.isAnimated === true) {
