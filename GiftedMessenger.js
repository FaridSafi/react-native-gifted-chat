...
import ShowSelectedPhoto from './ShowSelectedPhoto'
...
var GiftedMessenger = React.createClass({
  ...
  showImage(){
    ...
    this.setState({selectedImageShowing: true})
  },
  dismissImageShowing(){
    this.setState({selectedImageShowing: false})
  },
  renderAnimatedView() {
    return (
      <Animated.View
  ...
  render() {
      ...
      if(this.props.imagePicked){
        style= this.styles.showSelectedPhotoComponent
      }else{
        style= this.styles.dontShowSelectedPhotoComponent
      }
      return (
        ...
        >
         <ShowSelectedPhoto
                ...
                onSend={this.onSend}
                photo={this.props.imageToSend}
                buttonText={this.props.buttonText}
                sendButtonText={this.props.sendButtonText}
                cancel={this.props.dismissImageShowing}
                imagePicked={this.props.imagePicked}
                style={style}
          />  
    ...
    if (this.props.hideTextInput === false) {
        return (
          ...
          <View style={this.styles.textInputContainer}>
            ...
            >
              <Icon style={{marginTop: 10}} name="camera" size={25}/>   
            </Button>
  ...
  componentWillMount() {
    this.styles = {
      ...
      showSelectedPhotoComponent:{
        flex: 1,
        height: height,
        flexDirection: 'row',
      },
      dontShowSelectedPhotoComponent:{
        flex: 1,
        height: 0,    
        flexDirection: 'row',
      }
