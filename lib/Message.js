...
const androidWorkaroundStyles = {
    left: {
        container: StyleSheet.compose(styles.left.container, styles.androidWorkaround.androidWorkaround),
    },
    right: {
        container: StyleSheet.compose(styles.right.container, styles.androidWorkaround.androidWorkaround)
    }
};
