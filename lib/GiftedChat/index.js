...
function GiftedChat(props) {
    ...
    messageIdGenerator = () => (Math.random() + 1).toString(36).substring(7), user = {}, onSend, locale = 'en', colorScheme: colorSchemeProp, renderLoading, actionSheet, textInputProps, renderChatFooter, renderInputToolbar, isInverted = true, } = props;
    ...
    const renderMessages = useMemo(() => {
        ...
        <MessagesContainer {...messagesContainerProps} isInverted={isInverted} messages={messages} forwardRef={messagesContainerRef} isTyping={isTyping}/>
    ...
    return (<GiftedChatContext.Provider value={contextValues}>
      <ActionSheetProvider ref={actionSheetRef}>
        {/* @ts-expect-error */}
        <KeyboardAvoidingView behavior='padding' style={stylesCommon.fill} {...props.keyboardAvoidingViewProps}>
