...
export default class Bubble extends React.Component {
    ...
    renderMessageContact() {
        if (this.props.currentMessage && this.props.currentMessage.contact) {
            const { containerStyle, wrapperStyle, ...messageContactProps } = this.props;
            if (this.props.renderMessageContact) {
                return this.props.renderMessageContact(messageContactProps);
            }
            return <MessageContact {...messageContactProps}/>;
        }
        return null;
    }
    renderMessageVideo() {
        ...
        <View style={[
          ...
          <TouchableWithoutFeedback onLongPress={this.onLongPress} accessibilityTraits='text' {...this.props.touchableProps}>
            <View>
              ...
              {this.renderMesageLocation()}
              {this.renderMessageDocument()}
              {this.renderMessageContact()}
              <View style={[
...
Bubble.propTypes = {
    ...
    renderMessageDocument: PropTypes.func,
    renderMessageContact: PropTypes.func,
    renderMessageVideo: PropTypes.func,
    renderMessageLocation: PropTypes.func,
