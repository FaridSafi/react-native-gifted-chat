...
import { Image, StyleSheet, View, useWindowDimensions, StatusBar, } from 'react-native';
...
function ModalContent({ isVisible, imageSource, modalImageDimensions, imageProps, onClose }) {
...
export function MessageImage({ containerStyle, imageProps, imageSourceProps, imageStyle, currentMessage, }) {
    ...
    return (<View style={containerStyle}>
      <TouchableOpacity onPress={handleImagePress}>
        <Image {...imageProps} style={computedImageStyle} source={imageSource} onLayout={handleImageLayout} resizeMode='cover'/>
      </TouchableOpacity>

      <OverKeyboardView visible={isModalVisible}>
        <SafeAreaProvider>
          <ModalContent isVisible={isModalVisible} imageSource={imageSource} modalImageDimensions={modalImageDimensions} imageProps={imageProps} onClose={handleModalClose}/>
        </SafeAreaProvider>
      </OverKeyboardView>
    </View>);
}
