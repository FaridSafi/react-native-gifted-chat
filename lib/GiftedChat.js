...
class GiftedChat extends React.Component {
    ...
    renderMessages() {
        ...
        <MessageContainer {...messagesContainerProps} invertibleScrollViewProps={this.invertibleScrollViewProps} messages={this.getMessages()} forwardRef={this._messageContainerRef} isTyping={this.props.isTyping} androidWorkaround={this.props.androidWorkaround}/>
