...
export function Avatar(props) {
    const { isAvatarOnTop, isAvatarVisibleForEveryMessage, containerStyle, position, currentMessage, renderAvatar, previousMessage, nextMessage, imageStyle, onPressAvatar, onLongPressAvatar, } = props;
    ...
    if (renderAvatar === null)
        return null;
    if (!isAvatarVisibleForEveryMessage &&
        currentMessage &&
        messageToCompare &&
